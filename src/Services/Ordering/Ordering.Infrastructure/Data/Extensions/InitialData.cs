...
internal class InitialData
{
   ...
   new List<Customer>
   {
        Customer.Create(CustomerId.Of(new Guid("58c49479-ec65-4de2-86e7-033c546291aa")), "yishay", "yishay@gmail.com"),
    ...
    public static IEnumerable<Order> OrdersWithItems
    {
        get
        {
            var address1 = Address.Of("yishay", "gar", "yishay@gmail.com", "Bahcelievler No:4", "Israel", "Netanya", "38050");
            var address2 = Address.Of("john", "doe", "john@gmail.com", "Broadway No:1", "England", "Nottingham", "08050");

            var payment1 = Payment.Of("yishay", "5555555555554444", "12/28", "355", 1);
